...
<c:if test="${param.isRoot == 'true'}">
    <div class="row align-content-between">
        ...
        <c:if test="${sessionScope.role.equals('ADMIN')}">
            <form class="col-2" method="get" action="/lab_2_war_exploded/admin/categories/update">
            ...
            <form class="col-2" method="post" action="/lab_2_war_exploded/admin/categories/delete">
                <input type="text" name="categoryId" value="${category.id}" hidden>
