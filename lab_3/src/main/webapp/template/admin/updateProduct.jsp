    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 mt-5 mb-4 p-3 justify-content-center product-creation-block">
                <form id="product-update-form" autocomplete="off" class="form" action="" method="post">
                    <input type="text" name="productId" value="${requestScope.productDto.id}" hidden>
                    <h3 class="text-center mt-2">Update product</h3>

                    <c:if test="${param.success != null}">
                        <h5 class="text-center text-success">Product has been updated</h5>
                    </c:if>

                    <div class="row justify-content-center mt-4">
                        <div class="text-center col-10">
                            <label class="mb-1" for="name">Name:</label><br>
                            <input type="text" value="${requestScope.productDto.name}" name="name" maxlength="64" id="name" class="form-control">
                        </div>
                    </div>
