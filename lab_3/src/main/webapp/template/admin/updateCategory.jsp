    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 mt-5 mb-4 p-3 justify-content-center product-creation-block">
                <form id="update-category-form" autocomplete="off" class="form" action="" method="post">
                    <h3 class="text-center mt-2">Update category</h3>
                    ...
                    <c:if test="${requestScope.leafAndHasChildrenException}">
                        <p class="text-center error-message">Category with child categories cannot become leaf.</p>
                    </c:if>

                    <c:if test="${param.success != null}">
                        <h5 class="text-center text-success">Category has been updated</h5>
                    </c:if>
