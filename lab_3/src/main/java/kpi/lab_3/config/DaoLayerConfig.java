...
public class DaoLayerConfig {
  ...
  private static volatile List<Product> productsStub;
  private static volatile Map<Long, Category> categoriesMapStub;

  public static List<Product> initProductsStub() {
    if (productsStub == null) {
  ...
  public static List<Category> initCategoriesStub() {
    ...
    return new CopyOnWriteArrayList<>(categoriesMapStub.values());
  }
